 ...
 * Explains what the tool does and provides a button to begin.
 */
...
export default function WelcomeState({ onStart }: WelcomeStateProps) {
  return (
    <div className="flex flex-col items-center justify-center h-full px-4 py-12 text-center">
      ...
      <button
        onClick={onStart}
        className="px-6 py-3 bg-blue-700 hover:bg-blue-800 text-white text-sm font-semibold rounded-xl shadow transition-colors"
      >
